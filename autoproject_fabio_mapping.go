...
var autoFabioMap = autoAgroIrrigationInputMap{
	...
	CostQtyCells: map[string][]string{
		...
		"mao_obra":     {"D22", "F22", "K22", "M22", "R22", "T22", "Y22", "AA22", "AC22"},
		"energia":      {"D23", "F23", "K23", "M23", "R23", "T23", "Y23", "AA23", "AC23"},
		"combustivel":  {"D24", "F24", "K24", "M24", "R24", "T24", "Y24", "AA24", "AC24"},
		"curral":       {"D25", "F25", "K25", "M25", "R25", "T25", "Y25", "AA25", "AC25"},
		"irrigacao":    {"D26", "F26", "K26", "M26", "R26", "T26", "Y26", "AA26", "AC26"},
	},
	FixedCostCells: map[string][]string{
